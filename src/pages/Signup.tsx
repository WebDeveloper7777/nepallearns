        ...
        <div className="bg-card border rounded-lg shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">
              Sign up to get started with NepalLearns
            </p>
          </div>
